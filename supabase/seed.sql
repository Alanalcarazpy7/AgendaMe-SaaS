...
values
  (
    ...
    'gratis',
    'Gratis',
    'Para probar AgendaMe y empezar a recibir reservas online sin costo.',
  ...
  (
    ...
    'basico',
    'Básico',
    'Para negocios pequeños que quieren ordenar sus turnos, clientes y servicios.',
  ...
  (
    ...
    'profesional',
    'Profesional',
    'Para negocios con más movimiento que necesitan reportes, exportación y recordatorios.',
    'Más popular',
    199000,
    199000,
    1990000,
  ...
  (
    ...
    'empresarial',
    'Empresarial',
    'Para negocios con varias sucursales, equipos grandes y operación avanzada.',
    ...
    '[
      ...
      "Roles: gerente, recepcionista y personal",
